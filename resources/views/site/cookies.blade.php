...
@section('content')
    ...
    <div class="container py-10">
        ...
        <p>This Cookie Policy explains how Advanced Visual Technologies LLC ("Company," "we," "us," and "our") uses cookies and similar technologies to recognize you when you visit our website at
        <a href="https://localhost" target="_blank">https://localhost</a> ("Website"). It explains what these technologies are and why we use them, as well as your rights to control our use of them.</p>
        ...
        <ul>
            ...
            <li>
                <a href="http://www.youronlinechoices.com/" target="_blank">European Interactive Digital Advertising Alliance</a>
            </li>
        </ul>
        ...
        <p>If you have any questions about our use of cookies or other technologies, please <a href="">contact us</a></p>
    </div>
@endsection
